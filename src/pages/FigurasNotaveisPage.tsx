      ...
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              Pessoas que dedicaram suas vidas a construir, defender e
              enriquecer o Alto do Cabrito.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            <Search
              size={16}
              style={{ color: "var(--cinza-medio)", flexShrink: 0 }}
            />
            <input
              type="search"
          ...
          {categorias.map((cat) => (
            <button
              ...
              style={{
                ...
                backgroundColor:
                  filtro === cat ? "var(--laranja)" : "var(--cinza-card-bg)",
                color: filtro === cat ? "var(--preto)" : "var(--cinza-texto)",
                border:
                  filtro === cat ? "none" : "1px solid var(--cinza-borda)",
                fontSize: "13px",
                fontWeight: 600,
                fontFamily: "var(--font-primary)",
                cursor: "pointer",
        ...
        >
          ...
          {filtered.map((figura, i) => {
            const foto =
              figura._embedded?.["wp:featuredmedia"]?.[0]?.source_url ??
              figura.acf.foto?.url ??
              "";
            return (
              <motion.div
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <p
                        ...
                        dangerouslySetInnerHTML={{ __html: figura.acf.bio }}
                      />
